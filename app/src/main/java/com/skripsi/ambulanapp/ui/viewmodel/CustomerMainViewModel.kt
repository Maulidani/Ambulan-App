...
class CustomerMainViewModel(private val repository: Repository = Repository(ApiClient.instances)) :
    ViewModel() {
    ...
    private fun getDriver() {
        ...
        CoroutineScope(Dispatchers.Default).launch {
            ...
            while (true) {
                ...
                val client = repository.getLatLngDriver()
                client.enqueue(object : Callback<Model.ResponseModel> {
                    override fun onResponse(
                        call: Call<Model.ResponseModel>,
                        response: Response<Model.ResponseModel>
    ...
    private fun getHospital() {
        ...
        CoroutineScope(Dispatchers.Default).launch {
            ...
            while (true) {
                ...
                val client = repository.getLatLngHospital()
                client.enqueue(object : Callback<Model.ResponseModel> {
                    override fun onResponse(
                        call: Call<Model.ResponseModel>,
                        response: Response<Model.ResponseModel>
