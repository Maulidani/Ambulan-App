...
class AdminListAccountDriverActivity : AppCompatActivity(), AdapterListAccount.IUserRecycler {

    private val imgBack: ImageView by lazy { findViewById(R.id.imgBack) }
    private val fabAddAccountDriver: FloatingActionButton by lazy { findViewById(R.id.fabAddAccountDriver) }
    private val rv: RecyclerView by lazy { findViewById(R.id.rvAccountDriver) }
    ...
    private fun onClick() {
        ...
        fabAddAccountDriver.setOnClickListener {
            startActivity(
                Intent(this, AdminAddAccountDriverActivity::class.java)
                    .putExtra("action", "add")
            )
        }
    }
                        ...
                        if (response.isSuccessful && message == "Success") {
                            ...
                            val adapter =
                                data?.let {
                                    AdapterListAccount(
                                        it,
                                        this@AdminListAccountDriverActivity
                                    )
                                }
